...
- Adopted standardized strict provenance API.
- Resolved multiple lifetime elision warnings.
- Removed mangling disabling from the enclave applications's panic handler.
- Verified compatibility with Rust 1.92.
